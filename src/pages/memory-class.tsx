    ...
    return (
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          ...
          >
            <li>
              부모님의 속옷 서랍에 깜짝 선물을 넣어두는
              <br />
              다정한 아들 임건우
            </li>
            <li>
              컴퓨터와 기계에 관심이 많지만 마음은 늘<br />
              사람을 향하는 박시찬
            </li>
      ...
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          ...
          >
            ...
            <li>
              ‘목표를 세우면 그 목표가 나를 이끈다’며
              <br />
              계획표도 꼼꼼히 짜는 이보미
            </li>
            <li>아빠를 닮아 키가 크고 축구 보는 것을 좋아하는 최진아</li>
            <li>
              베스트 프렌즈 다섯 명의 우정에 ‘포에버’라는
              <br />
              이름을 지은 진윤희
            </li>
      ...
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          ...
          >
            ...
            <li>
              이다음에 크면 아빠랑 같이 술도 마셔주고 운전도
              <br />
              대신해주고 싶은 이단비
            </li>

            <li>
              언니가 유모차 태워 학교에 데려갔을 만큼 너무
              <br />
              예쁜 동생 이경민
            </li>

            <li>
              사촌 언니들과 아이스크림 먹으며 수다 떠는 게<br />
              즐거운 이은별
            </li>
            <li>아빠 등에 매달려 ‘나무늘보 놀이’를 즐기는 애교쟁이 구보현</li>

            <li>
              대학 가서 농사 공부하고 엄마랑 시골 살며 농사를
              <br />
              지으려는 김유민
            </li>
