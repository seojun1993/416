    ...
    return (
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          ...
          <br />
          오늘 교실에서 보실 책상 중 빈 책상은 살아돌아온 아이들의 책상이고,
          물건이 놓인 책상은 돌아오지 못한 아이들의{" "}
          <span
            css={css`
              letter-spacing: -0.1rem;
            `}
          ...
          지켜주세요.
          <br />
          살며시 의자에 앉아, 기억노트에 메시지를 작성해주세요. 또, 책상 우측에
          있는 QR코드를 통해 아이들과 선생님들의 이야기를 보실 수 있습니다.
          <br />
          ...
          <br />
          뛰어난 손재주로 가족을 위해 요리하는 김민희
          <br />
          그림 그리기를 좋아하는 자유로운 영혼의 김주아
          <br />
    ...
    return (
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          ...
          편지선물이 줄줄이 사탕처럼 매달려 있습니다.
          <br />
          마침 4월16일이 생일이었던 김초원 선생님을 생각하며 아이들은 2014년
          ...
          <br />
          좋아 하는 것, 중요한 것, 해야 할 것들을 똑부러지게 해내는
          <br />
          김담비
          <br />
    ...
    return (
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          ...
          빈하용
          <br />
          족발, 피자, 통닭, 먹고 싶은 것이 많은 만큼 마음 씀씀이도
          <br />
          넉넉한 강신욱
          <br />
          농구를 즐기는 중국어 능력자 안형준
    ...
    return (
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          ...
          신고한 아이가 있습니다. 당시 소방본부는 신고전화를 해경과 연결해
      ...
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          ...
          **닫을 것들을 제대로 닫았다면, 세월호는 그렇게 가라앉지 않았을
          ...
          <br />
          <br />
          전 세계 어려운 사람들을 찾아 돕는 일을 하고 싶은 이수진
          <br />
          고양이 다윤이가 새끼 낳던 날, 그 곁을 지켜준
          <br />
          고양이 언니 정다혜
          <br />
          네 잎 클로버를 키우는 소녀 권민경
          ...
          다정한 임세희
          <br />
          ‘목표를 세우면 그 목표가 나를 이끈다’며 계획표도 꼼꼼히 짜는
          <br />
          이보미
          <br />
    ...
    return (
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          ...
          <br />
          세월호가 침몰하던 그 날 그 바다를 보며 우리는 슬퍼하고 분노
          <br />
          ...
          이다혜
          <br />
          친구들 치마도 척척 고쳐주고 한 번 본 춤은 바로 따라 추는
          <br />
          재주꾼 이해주
          <br />
          ...
          국가자격증을 따놓은 김송희
          <br />
          이다음에 크면 아빠랑 같이 술도 마셔주고 운전도 대신해주고
          <br />
          싶은 이단비
          <br />
          ...
          <br />
          큰 대학병원 간호사가 돼 돈 많이 벌어
          <br />
          엄마에게 집을 사주고 싶은 강한솔
          <br />
          아르바이트하느라 고단한 언니의 대학 과제도 도와주는 실력파
          <br />
          동생 장혜원
          <br />
          카라멜 마끼아또에 네 잎 클로버 무늬를 띄워 엄마에게 건네고
          <br />
          싶은 장수정
          <br />
    ...
    return (
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          ...
          선생님 전수영
          <br />
          학생들 마음을 살필 수 있는 기회라며 꾸준히 방과후 상담을
          <br />
          하는 선생님 최혜정
          <br />
          <br />
