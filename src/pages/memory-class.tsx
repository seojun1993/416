...
협약기관 4.16세월호참사가족협의회, 경기도교육청, 경기도청, 경기도의회, 안산시, 안산교육지원청, 단원고등학교(7개 기관)`}
  ...
  "1반": (
    <MemoryClassContentDescription>
      ...
      <DescriptionContent>
        ...
        쓰던 공책과 필통. 그리고 시민들이 책상 위에 남긴 메시지와 하얀 국화꽃이
  ...
  "2반": (
    <MemoryClassContentDescription>
      ...
      <DescriptionContent>
        ...
        <br />
        따뜻하고 엉뚱하고 반짝이는 유머가 넘치던 2반 25명 아이들의 이름과 얼굴을
        떠올려 봅니다.
        <br />
        ...
        <br />책 읽는 것을 좋아하고, 소설 쓰는 것을 좋아하는 당당한 아이 송지나
        <br />
  ...
  "3반": (
    <MemoryClassContentDescription>
      ...
      <DescriptionContent>
        2학년 3반은 여학생반입니다. 34명의 학생이 수학여행을 떠나 26명의 학생이
        희생되고, 8명의 학생이 돌아왔습니다.
        <br />
        ...
        다채롭게 빛납니다. 장난꾸러기와 끼쟁이들이 많아서 경쾌하던 3반 교실에는
        이제 아이들의 수다와 웃음소리 대신 긴 침묵과 깊은 그리움, 갈 곳 잃은
        수백 개의 이야기만이 남아 있습니다.
        <br />
        ...
        그려집니다.
        <br />
        원래 반 아이들이 마음을 담아 정성껏 쓴 이 편지꾸러미는 배 안에서 전달할
        예정이었습니다. 하지만 편지를 교실에 남겨 둔 채 수학여행을 떠나게
        되었고, 그렇게 남아 있는 34개의 편지들은 오래 담아두고 기억할 이야기로
        교실에 영원히 남았습니다.
        <br />
        이날 밤 선실에서 3반 아이들은 케이크를 들고 있는 담임선생님과 함께 단체
        사진을 남겼습니다. 김초원 선생님은 감동을 받아 빨개진 눈으로 활짝 웃고
        있고, 아이들은 3반의 트레이드마크 같은 피스 포즈를 취하며 잊지 못할
        수학여행 추억에 만족한 얼굴입니다.
        <br />
  ...
  "5반": (
    <MemoryClassContentDescription>
      ...
      <DescriptionContent>
        ...
        바로, 커튼입니다.
        <br />
        2학년 5반과 6반은 특별활동교실이었기 때문에 다른 반 교실과 달리 복도 쪽
        창이 작고 커튼 대신 암막 블라인드가 설치되어 있습니다.
        <br />
        또한 2학년 5반 교실을 둘러보면 ‘모두가 주인 되는 2학년 5반’ 게시물과,
        ‘2학년 5반의 학급규칙’ 판넬을 발견할 수 있는데요.
        <br />
        반장, 부반장, 서기, 총무와 같은 기본적인 역할 뿐만 아니라 학급에 필요한
        다양한 역할이 세심하게 나눠져 있습니다.
        <br />
  ...
  "6반": (
    <MemoryClassContentDescription>
      ...
      <DescriptionContent>
        ...
        <br />
        부모님들은 영인이가 갖고 싶어 했던 축구화, 현철이가 즐겨 연주하던 기타를
        팽목항에 갖다 놓으며 간절하게 기다렸지만 두 아이는 인양된 세월호에서도
        발견되지 않았습니다.
        <br />
  ...
  "7반": (
    <MemoryClassContentDescription>
      ...
      <DescriptionContent>
        ...
        <br />
        2학년 7반 교실의 시계는 우리가 기억해야 하는 사람들과 계속 관심을 가져야
        하는 이야기들을 온 몸으로 나타내고 있습니다.
        <br />
  ...
  "8반": (
    <MemoryClassContentDescription>
      ...
      <DescriptionContent>
        ...
        보다 구체적으로 이 교실에 남은 삶의 흔적들을 떠올려 보는 일일 것입니다.
        <br />
    ...
    <MemoryClassContentDescription>
      ...
      <DescriptionContent>
        ...
        **닫을 것들을 제대로 닫았다면, 세월호는 그렇게 가라앉지 않았을
        ...
        교실 칠판 옆 게시판을 봐주세요.
        <br />
        아이들이 함께 쓰는 공간을 잘 유지하기 위한 역할분담표를 붙여놓았습니다.
        <br />
        칠판, 복도, 교실, 음악실 청소.
        <br />
        ...
        <br />
        육지에서, 바다에서, 배에서, 어른들이 맡은 일을 제때 제대로 하지 않았기에
        우리 곁을 떠나간 2학년 9반 아이들의 이름을 불러봅니다.
        <br />
        전 세계 어려운 사람들을 찾아 돕는 일을 하고 싶은 이수진 고양이 다윤이가
        새끼 낳던 날, 그 곁을 지켜준 고양이 언니 정다혜
        <br />
        네 잎 클로버를 키우는 소녀 권민경
        <br />
        ...
        <br />
        <br />
        다음 안내는 좌측 10반 교실 버튼을 눌러주시고, 돌아가려면 좌측 하단 메뉴
        버튼을 눌러주세요.
      </DescriptionContent>
    </MemoryClassContentDescription>
  ),
  "10반": (
    <MemoryClassContentDescription>
      ...
      <DescriptionContent>
        ...
        교실의 칠판을 가만히 보아주세요.
        <br />
        ‘두 달 전에 왔을 때는 여기 칠판이 가득 찼었는데 오늘 와보니 칠판이 너무
        허전하네요’라는 글이 보입니다.
        <br />
        ...
        <br />
        2014년 4월 16일의 약속을 기억하며 2학년 10반 아이들의 이름을 불러봅니다.
        <br />
  ...
  교무실: (
    <MemoryClassContentDescription>
      ...
      <DescriptionContent>
        ...
        선생님들은 5층 객실을 사용했습니다.
        <br />
        아침식사를 마치고 한가로운 시간, 갑자기 배가 기울었지만상황에 대한 아무
        설명도 없이 제자리에서 대기하라는 방송만 반복됐습니다.
        <br />
        ...
        <br />
        제자들에게 더 많은 세상을 경험하는 여행을 떠나라 조언하는 선생님 남윤철
        <br />
        ...
        <br />
        항상 학생을 생각하는 선생님이 되겠다는 첫 다짐을 실천하는 선생님 전수영
        <br />
