      ...
      <MemoryClassContentDescription>
        <DescriptionWrapper>
          ...
          <DescriptionContent>
            ...
            협약을 통해 별도의 시설 건립 후 이전·복원하기로 결정했습니다.
            <br />
            단원고 4.16기억교실은{" "}
            <b
              css={css`
            ...
            교육원 건립과 함께 임시공간에서 이전하였으며 단원고 학생들이
            사용하였던 책상, 의자, 칠판, 게시판, 교실 문틀, 교실 문, 창틀, 창문,
            천장텍스, 몰딩 등 교실 기록물을 그대로 복원하여 4.16민주시민교육원
            기억관 2층, 3층에 자리 잡게 되었습니다.
            <br />
        ...
        <DescriptionWrapper>
          ...
          <DescriptionContent>
            ...
            <br />
            <b>소장기관: 4.16민주시민교욱원, 4.16기억저장소</b>
          </DescriptionContent>
        </DescriptionWrapper>
      </MemoryClassContentDescription>
    );
  ...
  "1반": () => {
    ...
    return (
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          2학년 1반은 여학생반입니다. 37명의 학생이 수학여행을 떠나
          <br />
          18명의 학생이 희생되고, 19명의 학생이 돌아왔습니다.
          <br />
          1반은 단원고 10개 반 중 가장 많은 학생이 살아 돌아온 반입니다.
          <br />
          교실 책상 중 빈 책상은 살아 돌아온 아이들의 책상이고, 물건이 놓인
          책상은 돌아오지 못한 아이들의{" "}
          <span
            css={css`
              letter-spacing: -0.1rem;
          ...
          놓여있는 물품들은 보고 만져도 되지만 모두 실제 물품이니 소중하게
          지켜주세요.
          <br />
          살며시 의자에 앉아, 기억노트에 메시지를 작성해 주세요. 또, 책상 위
          우측 상단에 있는 QR코드를 통해 아이들과 선생님들의 이야기를 보실 수
          있습니다.
          <br />
          세월호 참사 당시 텅 비어 버린 단원고 2학년 교실에는 아이들이 쓰던
          공책과 필통. 그리고 시민들이 책상 위에 남긴 메시지와 하얀 국화꽃이
          피어나고 있었습니다. 수학여행 간 아이들의 무사 귀환을 간절히 기다리던
          부모들은 아들딸의 책상과 의자를 끌어안아야 했습니다.
          <br />
          평범한 고등학생들의 일상이 담겨있던 10개의 교실은 그날{" "}
          <span
            css={css`
              letter-spacing: -0.1rem;
              li {
          ...
          세월호 참사의 현장이자 증거가 되었습니다.
          <br />
          ‘보고싶고 사랑한다’는 말들이 빼곡히 적혀 있는 칠판, ‘빨리 돌아오라’는
          포스트잇으로 도배된 창문, 말갛게 웃고 있는 아이들의 사진과 꽃, 편지,
          간식들이 수북이 쌓인 책상.
          <br />
          시간이 멈춘 교실에는 아이들의 온기를 품은 듯한 햇볕이 위로처럼
          내려앉아 있었습니다.
          <br /> 1반 교실에는 아이들이 직접 만들어서 사용한 달력이 복도 쪽 벽에
          ...
          제자들이 남긴 메시지를 볼 수 있습니다. <br />
          제발 돌아와 달라는 애원, 대학 합격했다는 소식, 꿈에 나와달라는 부탁,
          사랑한다는 말들이 안타깝게 내려앉아 있습니다.
  ...
  "2반": () => {
    ...
    return (
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          2학년 2반은 여학생반입니다. 36명의 학생이 수학여행을 떠나
          <br />
          (배를 탄) 25명의 학생이 희생되고, 11명의 학생이 돌아왔습니다.
          <br />
          ...
          담았습니다.
          <br />
          아이들의 체취와 숨결이 머물던 단원고 2학년 교실은 그렇게 사라지게
          되었습니다. 세월호 참사의 현장이자 흔적이었던 교실을 새로운 교육을
          위한 현장으로 만들기 위한 유가족과 시민들의 노력으로 세 번의 이사 끝에
          ...
          <br />
          교실 뒤쪽 게시판에는 2반 친구들의 정겨운 단체사진을 크게 프린트한
          판넬이 눈에 띕니다. 손가락으로 브이를 그리고, 꽃받침을 하며 카메라를
          바라보는 아이들의 눈동자에는 2학년 생활에 대한 기대와 설렘이
          어려있습니다.
          <br />
          사진 안에 ‘서로를 존중하는 완소2반’이란 글자를 보면, 소중하고 귀하기만
          했던 아이들과 빛나던 한 시절이 스쳐 지나갑니다.
          <br />
          담임 전수영 선생님은 교실 뒤에 ‘칭찬합시다’ 게시판을 만들어 아이들이
          반을 위해 배려했던 내용을 적도록 했습니다.
          <br />
          ...
          >
            ...
            <li>뭘 하든 최선을 다해야 직성이 풀리는 미래의 역사학자 남수빈</li>
    ...
    return (
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          ...
          친구 등에 업힌 아이, 바닥에 주저앉아 있는 아이들이 벚꽃보다 더 밝고
          다채롭게 빛납니다.
          <br />
          장난꾸러기와 끼쟁이들이 많아서 경쾌하던 3반 교실에는 이제 아이들의
          수다와 웃음소리 대신 긴 침묵과 깊은 그리움, 갈 곳 잃은 수백 개의
          이야기만이 남아 있습니다.
          <br />
          교실 뒤쪽 게시판에는 3반 친구들이 담임 김초원 선생님을 위해 준비했던
          편지 선물이 줄줄이 사탕처럼 매달려 있습니다.
          <br />
          마침 4월 16일이 생일이었던 김초원 선생님을 생각하며 아이들은 2014년
          당일 자정에 깜짝 생일파티를 준비했습니다.
          <br />
          케이크도 직접 만들고, 선생님께 잘 어울릴 액세서리도 미리 골라두고,
          두근두근한 마음으로 서프라이즈 파티를 기다렸을 아이들 모습이
          그려집니다.
          <br />
          원래 반 아이들이 마음을 담아 정성껏 쓴 이 편지 꾸러미는 배 안에서
          전달할 예정이었습니다. 하지만 편지를 교실에 남겨 둔 채 수학여행을
          떠나게 되었고, 그렇게 남아있는 34개의 편지들은 오래 담아두고 기억할
          이야기로 교실에 영원히 남았습니다.
          <br />
          ...
          >
            ...
            <li>
              좋아하는 것, 중요한 것, 해야 할 것들을 똑부러지게 해내는
              <br />
              김담비
            </li>
  ...
  "4반": () => {
    ...
    return (
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          2학년 4반은 남학생반입니다. 37명의 학생이 수학여행을 떠나 28명의
          학생이 희생되고 9명의 학생이 돌아왔습니다.
          <br />
          2014년 4월 16일 오전 8시 49분, 세월호가 왼쪽으로 45도 <br />
          기울어집니다. 배가 45도로 기울면 복원이 어려우므로 빠르게 퇴선 조치를
          해야 합니다.
          <br />
          ...
          <br />
          결국, 아이들은 뒤늦게 육지로 올라왔고 가족들이 아이들을 만난 장소는
          ‘팽목항’이었습니다. 팽목항은 세월호 침몰 소식을 들은 국민들이 한
          마음으로 달려와 간절한 바람을 보냈던 곳입니다.
          <br />
          2014년 4월 16일부터 세월호가 인양되기 시작한 2017년 3월까지 이곳에는
          미수습자 가족들이 머무르고 있었습니다.
          <br />
          인양 이후에는 목포로 옮겨가게 되어 팽목항의 텐트나 가건물은
          철거되었지만, 컨테이너 박스에 꾸려진 ‘팽목 기억관’이 시민들이 찾을 수
          있는 분향소이자 기억관의 역할을 하고 있습니다.
          <br />
          ...
          >
            <li>
              ‘안 먹으면 안 돼지’라는 상호까지 준비한 미래의 고깃집 사장
              <br />
              안준혁
            </li>
            ...
            <li>
              친구들이 인정한 만화가, 그림 실력으로 음악밴드 멤버가 된<br />
              홍순영
            </li>
            ...
            <li>
              록밴드 ‘GreenDay’처럼 소울 있는 노래를 만들고 싶은
              <br />
              강승묵
            </li>
            <li>수영선수 시절 다져진 몸매로 모델을 준비하는 슬라바</li>
            <li>책 읽기와 글쓰기를 좋아하는 작가지망생 김윤수</li>
            <li>
              스케치북과 연필만 있으면 OK, 그림 그리는 게 제일 좋은
              <br />
              빈하용
            </li>
            <li>
    ...
    return (
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          ...
          바로, 커튼입니다.
          <br />
          2학년 5반과 6반은 특별활동 교실이었기 때문에 다른 반 교실과 달리 복도
          쪽 창이 작고 커튼 대신 암막 블라인드가 설치되어 있습니다. 또한 2학년
          5반 교실을 둘러보면 ‘모두가 주인 되는 2학년 5반’ 게시물과, ‘2학년
          5반의 학급규칙’ 판넬을 발견할 수 있는데요.
          <br />
          반장, 부반장, 서기, 총무와 같은 기본적인 역할 뿐만 아니라 학급에
          필요한 다양한 역할이 세심하게 나눠져 있습니다. 이런 약속들을 만들기
          위해 머리를 맞대고 회의했을 2학년 5반 아이들의 모습을 하나하나 떠올려
          봅니다.
          <br />
          <br />
          <ul
          ...
          >
            ...
            <li>손으로 조립하는 것을 잘 하고 동물을 좋아하는 김인호</li>
            <li>친구들의 고민상담사이자 합기도에 푹 빠진 김진광</li>
  ...
  "6반": () => {
    ...
    return (
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          2학년 6반은 남학생반입니다. 38명의 학생이 수학여행을 떠나 25명의
          학생이 희생되고 13명의 학생이 돌아왔습니다.
          <br />
          6반에는 침몰하는 세월호 안에서 “배가 가라앉고 있다”고 119에 최초로
          신고한 아이가 있습니다. 당시 소방본부는 신고 전화를 해경과 연결해
          상황을 공유했는데 해경은 신고자가 탑승객이라고 했음에도 반복적으로
          위도와 경도를 물었습니다.
          <br />
          ...
          <br />
          가족들은 2017년 11월 20일, 참사 발생 1,315일 만에 편지와 유품을 모아
          두 아이를 하늘로 보내주었습니다.
          <br />
          기억교실에서 수학여행에서 돌아오면 하고 싶은 일이 많았을 2학년 6반
          25명의 친구를 떠올려 봅니다.
          <br />
          <br />
          <ul
          ...
          >
            ...
            <li>
              선한 미소와 밝은 기운으로 주변 사람을 무장해제 시켜버린
              <br />
              이영만
            </li>
            ...
            <li>
              법관이 되어 평등한 세상을 위한 나만의 역할을 하고 싶은
              <br />
              홍종영
            </li>
            <li>
              도움이 필요한 사람에게 꼭 손을 내밀곤 하는 가족 바라기
              <br />
              정원석
            </li>
            <li>교실 앞자리에서 빛나는 눈으로 수업에 집중했을 김동영</li>
            <li>
              엄마가 처음으로 쓴 손편지와 함께 생일에 수학여행을 떠난
              <br />
              전현탁
            </li>
  ...
  "7반": () => {
    ...
    return (
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          2학년 7반은 남학생반입니다. 33명의 학생이 수학여행을 떠나 32명의
          학생이 희생되고 단 한 명의 학생이 돌아왔습니다.
          <br />
          7반은 가장 많은 학생이 희생된 반이고, 세월호에서 마지막으로 탈출한
          학생이 있는 반입니다. 이 학생조차 해경이 구한 것이 아니라 스스로
          탈출해 살았던 것입니다.
          <br />
          2학년 7반 교실의 시계는 우리가 기억해야 하는 사람들과 계속 관심을
          가져야 하는 이야기들을 온몸으로 나타내고 있습니다.
          <br />
          단원고 4.16기억교실 각 반에 있는 시계는 시간의 흐름에 따라 자연스럽게
          ...
          >
            <li>
              공부에 쓸 학용품을 꼼꼼히 고르며 과학 선생님의 꿈을 키워간
              <br />
              이근형
            </li>
            <li>
              가족들에게는 애기였지만 사실은 의젓하고 어른스러운
              <br />
              이민우
            </li>
            ...
            <li>
              &lt;Let it go&gt;를 좋아하고 엉뚱한 말로 웃음을 줄 줄 아는
              <br />
              김수빈
            </li>
            <li>
              여동생을 너그럽게 살피고 로봇을 꼼꼼히 조립할 줄 아는
              <br />
              정동수
            </li>
            <li>엄마 품과 엄마 냄새를 좋아해 전막내라고 불린 전찬호</li>
            <li>
              운동을 좋아하고 리더십 있는 성격으로 경찰이 되고 싶은
              <br />
              심장영
            </li>
            <li>21명의 친구들과 뜨겁고 빛나는 우정을 주고받은 양철민</li>
            <li>
              무뚝뚝한 듯해도 다정하고, 투박한 듯해도 섬세한 성격의
              <br />
              안중근
            </li>
            <li>
              성대모사는 기본, 익살과 재치를 두루 갖춘 웃음 제조기
              <br />
              이진형
            </li>
            <li>흥도, 끼도, 꿈도 넘치는, 친구들의 수학선생님 김민수</li>
            <li>
              모두가 감탄하는 맛의 떡볶이를 뚝딱 만들어 내는 요리사
              <br />
              손찬우
            </li>
            <li>항상 밝아 칭찬이 절로 나왔던 두 누나의 막내 동생 김기수</li>
            <li>
              여리고 약한 것을 잘 돌보고 단발머리가 멋지게 어울리는
              <br />
              최현주
            </li>
            ...
            <li>
              하얀 물뱀 태몽으로 엄마에게 온, 파충류 전문 학자를 꿈꾼
              <br />
              허재강
            </li>
            ...
            <li>
              아빠의 사랑 속에서 쑥쑥 자라 패션모델이라는 꿈을 가진
              <br />
              이정인
            </li>
          </ul>
  ...
  "8반": () => {
    ...
    return (
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          2학년 8반은 남학생반입니다. 31명의 학생이 수학여행을 떠나 29명의
          학생이 희생되고 두 명의 학생이 돌아왔습니다.
          <br />
          2학년 8반 아이들이 교실 달력에 ‘수, 학, 여, 행’ 네 글자를 적어 놓을 때
          마음이 어땠을지를 생각하면 절대로 일어나서는 안 되는 일이었습니다.
          <br />
          이과반은 문과반에 비해 인원수가 적은 편입니다. 2014년 단원고등학교
          2학년 이과반 남학생들은 2개 반 64명 중 단 3명만이 우리 곁으로
          돌아왔습니다.
          <br />
          시간이 흐를수록 지워지고 잊혀지는 시간 속에서 우리가 할 수 있는 일은
          ...
          >
            <li>
              부모님의 속옷 서랍에 깜짝 선물을 넣어두는 다정한 아들
              <br />
              임건우
            </li>
            <li>
              컴퓨터와 기계에 관심이 많지만 마음은 늘 사람을 향하는
              <br />
              박시찬
            </li>
            ...
            <li>
              스스로 컴퓨터를 고칠 수 있지만 엄마에게는 영원한 ‘아기’,
              <br />
              이승민
            </li>
            <li>
              공군사관학교 출신 파일럿이 되고 싶어 차근차근 나아간
              <br />
              홍승준
            </li>
            <li>
              여러 분야에 관심이 많은 취미부자, 붙임성 좋은 개구쟁이
              <br />
              이재욱
            </li>
            <li>
              분해하고 다시 조립하는 모든 것을 단 하루 만에 해내는
              <br />
              김영창
            </li>
            <li>
              수학여행 가기 전, 맘에 드는 옷과 운동화를 장만해 설렌
              <br />
              백승현
            </li>
            ...
            <li>
              창의적으로 자유롭게! ‘구글’에서 일하는 프로그래머가 꿈인
              <br />
              김재영
            </li>
  ...
  "9반": () => {
    ...
    return (
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          2학년 9반은 여학생반입니다. 22명의 학생이 수학여행을 떠나 20명의
          학생이 희생되고 두 명의 학생이 돌아왔습니다.
          <br />
          <br />
          ...
          **닫을 것들을 제대로 닫았다면, 세월호는 그렇게 가라앉지 않았을
          ...
          >
            ...
            <li>
              고양이 다윤이가 새끼 낳던 날, 그 곁을 지켜준 고양이 언니
              <br />
              정다혜
            </li>
            ...
            <li>
              중국 안산시에서 나고 자라 중학생 때 한국 안산시에 온 친구
              <br />
              배향매
            </li>
            <li>수의사를 꿈꿨지만 이제는 뮤지컬 배우가 되고 싶은 편다인</li>
            <li>
              기타도 연극도, 하고 싶은 일이 생기면 조용히 타오르는 불꽃
              <br />
              오경미
            </li>
            <li>
              배 만드는 사람이 되고 싶어서 서점을 돌며 조선공 책을 찾는
              <br />
              김혜선
            </li>
            <li>
              아빠의 흰머리를 염색하고 엄마 얼굴에 팩을 해주는 다정한
              <br />
              임세희
            </li>
            <li>
              ‘목표를 세우면 그 목표가 나를 이끈다’며 계획표도 <br />
              꼼꼼히 짜는 이보미
            </li>
            <li>아빠를 닮아 키가 크고 축구 보는 것을 좋아하는 최진아</li>
            <li>
              베스트 프렌즈 다섯 명의 우정에 ‘포에버’라는 이름을 지은
              <br />
              진윤희
            </li>
  ...
  "10반": () => {
    ...
    return (
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          2학년 10반은 여학생반입니다. 21명의 학생이 수학여행을 떠나 20명의
          학생이 희생되고 한 명의 학생이 돌아왔습니다.
          <br />
          10반 교실 칠판에는 ‘두 달 전에 왔을 때는 여기 칠판이 가득 찼었는데
          오늘 와보니 칠판이 너무 허전하네요’라는 글이 보입니다.
          <br />
          ‘우리가 분필을 들고 있는 한 세월호는 지워지지 않는다’
          <br />
          칠판 아래에 다짐처럼 적은 한 문장이 오래 눈길을 끕니다.
          <br />
          세월호가 침몰하던 그날 그 바다를 보며 우리는 슬퍼하고 분노
          <br />
          했습니다. 다시는 이런 희생이 생기지 않도록 우리 교육이 살아
          <br />
          나길 바랍니다.
          <br />
          아픔 속에서 희망이 피어나는 세상을 기다립니다.
          <br />
          2014년 4월 16일의 약속을 기억하며 2학년 10반 아이들의
          <br />
          이름을 불러봅니다.
          <br />
          <br />
          ...
          >
            ...
            {zoom <= 1 ? (
              <li>
                할 줄 아는 게 수학밖에 없으니 장래 희망도 수학 선생님이라는
                <br />
                이다혜
              </li>
            ) : zoom < 1.1 ? (
            ...
            {zoom <= 1 ? (
              <li>
                친구들 치마도 척척 고쳐주고 한 번 본 춤은 바로 따라 추는 재주꾼
                <br />
                이해주
              </li>
            ) : (
              <li>
                친구들 치마도 척척 고쳐주고 한 번 본 춤은 바로 따라 추는 <br />
                재주꾼 이해주
              </li>
            )}
            ...
            {zoom <= 1 ? (
              <li>
                수학여행 사진 찍어 날마다 엄마에게 보낼테니 그거 보고 웃으라는
                <br />
                권지혜
              </li>
            ) : (
            ...
            {zoom <= 1 ? (
              <li>
                스무 살부터는 돈 벌어 집안을 일으켜보리라, 국가자격증을 따놓은
                <br />
                김송희
              </li>
            ) : (
            ...
            {zoom <= 1 ? (
              <li>
                이다음에 크면 아빠랑 같이 술도 마셔주고 운전도 대신해주고 싶은
                <br />
                이단비
              </li>
            ) : (
            ...
            {zoom >= 1.1 ? (
              <li>
                언니가 유모차 태워 학교에 데려갔을 만큼 너무 예쁜 동생
                <br />
                이경민
              </li>
            ) : (
            ...
            <li>사촌 언니들과 아이스크림 먹으며 수다 떠는 게 즐거운 이은별</li>
            ...
            {zoom <= 1 ? (
              ...
              <li>
                대학 가서 농사 공부하고 엄마랑 시골 살며 농사를 지으려는
                <br />
                김유민
              </li>
            ) : (
            ...
            <li>
              큰 대학병원 간호사가 돼 돈 많이 벌어 엄마에게
              <br />
              집을 사주고 싶은 강한솔
            </li>
            <li>
              아르바이트하느라 고단한 언니의 대학 과제도 도와주는
              <br />
              실력파 동생 장혜원
            </li>
            {zoom <= 1 ? (
              <li>
                카라멜 마끼아또에 네 잎 클로버 무늬를 띄워 엄마에게 건네고 싶은
                <br />
                장수정
              </li>
            ) : zoom < 1.1 ? (
              <li>
                카라멜 마끼아또에 네 잎 클로버 무늬를 띄워 <br />
                엄마에게 건네고 싶은 장수정
              </li>
            ) : (
              <li>
          ...
          <br />
          <br />
          열여덟의 우정과 사랑으로 다정다감한 2학년 10반 스무 명 친구들을
          오래오래 기억하겠습니다.
          <br />
          <br />
          다음 안내는 상단에 교무실 버튼을 눌러주시고, <br />
          돌아가려면 좌측 하단 메뉴 버튼을 눌러주세요.
        </DescriptionContent>
      </MemoryClassContentDescription>
    );
    ...
    return (
      <MemoryClassContentDescription>
        ...
        <DescriptionContent>
          ...
          안전장비에 대해 인지하고 있었지만, ‘위험하니 절대로 움직이지 말고
          대기하라’는 선원의 방송으로 아이들과 선생님들은 모두 움직일 수
          없었습니다.
          <br />
          ...
          >
            ...
            {zoom <= 1 ? (
              ...
              <li>
                학생들의 개성을 키우는 맵시 있는 교육을 고민하는 선생님
                <br />
                김초원
              </li>
            ) : (
            ...
            {zoom <= 1 ? (
              <li>
                제자들에게 더 많은 세상을 경험하는 여행을 떠나라 조언하는
                <br />
                선생님 남윤철
              </li>
            ) : zoom < 1.1 ? (
            ...
            {zoom <= 1 ? (
              <li>
                학생들의 환경과 처지를 먼저 살피고 이해하려 노력하는 선생님
                <br />
                박육근
              </li>
            ) : zoom < 1.1 ? (
            ...
            {zoom <= 1 ? (
              ...
              <li>
                학교 텃밭의 여린 채소를 키우듯 학생들을 다독이는 선생님
                <br />
                양승진
              </li>
            ) : (
            ...
            {zoom <= 1 ? (
              <li>
                좋은 교사, 좋은 아빠, 좋은 남편, 누구에게나 참 좋은 선생님
                이해봉
              </li>
            ) : zoom < 1.1 ? (
              <li>
            ...
            <li>
              항상 학생을 생각하는 선생님이 되겠다는 첫 다짐을 실천하는
              <br />
              선생님 전수영
            </li>
            {zoom <= 1 ? (
              <li>
                학생들 마음을 살필 수 있는 기회라며 꾸준히 방과후 상담을 하는
                <br />
                선생님 최혜정
              </li>
            ) : zoom < 1.1 ? (
          ...
          <br />
          <br />
          생의 마지막까지 선생님의 자리에 서 있던, <br />
          11명의 선생님들을 오래오래 기억하겠습니다.
          <br />
          <br />
          홈으로 돌아가려면 좌측 하단 메뉴 버튼을 눌러주세요.
        </DescriptionContent>
      </MemoryClassContentDescription>
    );
  },
